...
public class Main_Trees {
        public static void main(String[] args) {
                TreeNode root=null;
                int a[]={5,1,6,8,2,3,9};
                TreePrinter<TreeNode> printer = new TreePrinter<>(n->""+n.val, n->n.left, n->n.right);
             ...
             //for(var i:mp.entrySet())System.out.println(i.getKey().val+" ->"+i.getValue().val);
...
static TreeNode insert(TreeNode root,int data){
    ...
    else if(root.val< data)root.right=insert(root.right,data);
    return root;
