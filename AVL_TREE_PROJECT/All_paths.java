...
public class All_paths {
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println("All paths from Root Node :");
        List<List<Integer>> ans=all_paths(root);
        for(var i:ans)System.out.println(i);
        System.out.println();
        
    }


    static List<List<Integer>> all_paths(tree root){
    ...
    static void helper(tree root,List<Integer> l,List<List<Integer>> ans){
